...
describe ('US: Tela de login', ()=> {
    ...
    */
    ...
    it.only('Login com sucesso: usuário e senha válidos - usando massa Fixture', () => {
        cy.fixture("usuario").then((user) => {
            cy.login(user.email, user.senha)
        })
    });
it('Login com sucesso: usuário e senha válidos - usando comando customizando', () => {
    cy.login('iasminvictoria@hotmail.com', 'iasmin0411{enter}')
...
it.only('Login com sucesso: usuário e senha válidos - usando massa importada', () => {
